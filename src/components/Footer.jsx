  ...
  return (
    <footer className="bg-warmWhite pt-16 pb-6">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Delivery</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-600">contact@foreveryou.com</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Newsletter - Optional Addition */}
        <div className="mt-12 mb-8 lg:w-1/2">
        ...
        <div className="pt-8 border-t border-gray-200 mt-12">
          <p className="text-center text-gray-500 text-sm">
            Copyright © {currentYear} Forever You. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
