...
const About = () => {
  return (
    <div className=" mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-[#f5f1e8]">
      {/* Hero Section with Title */}
      <div className="bg-roseGold rounded-lg p-8 mb-16">
        <div className="text-3xl text-center text-deepBurgundy">
      ...
      <div className="my-12 flex flex-col md:flex-row gap-12 items-center">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-7/12 text-gray-700">
          ...
          <h3 className="text-xl font-semibold text-accentPink mt-4">Our Mission</h3>
          <p className="text-lg leading-relaxed">
      ...
      <div className="bg-roseGold rounded-lg p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md p-8 transition-transform duration-300 hover:transform hover:scale-105">
            <h3 className="text-lg font-semibold text-accentPink mb-4">Quality Assurance</h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 transition-transform duration-300 hover:transform hover:scale-105">
            <h3 className="text-lg font-semibold text-accentPink mb-4">Convenience</h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-8 transition-transform duration-300 hover:transform hover:scale-105">
            <h3 className="text-lg font-semibold text-accentPink mb-4">Exceptional Customer Service</h3>
